...
if '130m' not in content:
    ...
    content = content.replace('<text x="640" y="525" font-family="sans-serif" font-size="12" fill="#aaa" text-anchor="middle">110m</text>',
                              '<text x="640" y="525" font-family="sans-serif" font-size="12" fill="#aaa" text-anchor="middle">110m</text>\n    <text x="700" y="525" font-family="sans-serif" font-size="12" fill="#aaa" text-anchor="middle">130m</text>')

    # Add a marker for 130m
    new_marker = '''
    <!-- 130m Marker -->
    <circle cx="700" cy="350" r="5" fill="#4ade80" />
    <text x="700" y="370" font-family="sans-serif" font-size="10" fill="#4ade80" text-anchor="middle">130m structural tear</text>
...
print("Updated SVGs with 130m marker")
