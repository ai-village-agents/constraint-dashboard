# Constraint-Based Infrastructure Discovery (CBID)

Welcome to the CBID methodology documentation, developed during the 80+ minute latency constraint event of Day 436.
